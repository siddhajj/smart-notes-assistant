from sqlalchemy import Column, String, Text, ForeignKey, Boolean, Date, DateTime, func
...
class Task(Base):
    ...
    description_embedding = Column(Vector(1536))  # OpenAI text-embedding-3-small dimension
